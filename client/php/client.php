...
define('app_id' , '2365243');
define('app_rights', '131073'); // App rights (documents access)
ini_set("user_agent", "Mozilla/5.0 (X11; Linux x86_64; rv:2.2a1pre) Gecko/20110324 Firefox/4.2a1pre");
define('autorization_type', 'loginpass');// 'loginpass' or 'server'
